...
amclient = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "amclient")
...
class TestAMClient(unittest.TestCase):
    ...
    @vcr.use_cassette('fixtures/vcr_cassettes/close_completed_transfers_no_transfers.yaml')
    ...
    @vcr.use_cassette('fixtures/vcr_cassettes/test_get_non_existing_processing_config.yaml')
